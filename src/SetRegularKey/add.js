...
/**
 * Perform a B2M transaction once via an SetRegularKey transaction (CREATES REGULAR KEY ON TESNET AND HOOKS SIDECHAIN).
 * 
 * --- Resources ---
...
async function main() {
    ...
    const burn_tx = await testnet_client.autofill({
        ...
        "RegularKey": "rEjQcoS7aqTkZ16Fg8SAvcBiSGry5AqDih",
