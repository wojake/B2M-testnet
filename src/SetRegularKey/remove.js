...
/**
 * Perform a B2M transaction once via an SetRegularKey transaction (REMOVES REGULAR KEY ON TESTNET AND HOOKS SIDECHAIN).
 * 
 * --- Resources ---
